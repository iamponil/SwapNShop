...
//******************Livraison********************************
Route::get('/Livraison', [\App\Http\Controllers\LivraisonnnController::class, 'index'])->name('showLivraison');
Route::post('/Livraison', [\App\Http\Controllers\LivraisonnnController::class , 'store'])->name('showLivraisonadded');
Route::get('/addLivraison', [\App\Http\Controllers\LivraisonnnController::class, 'create'])->name('view');
Route::get('/updateLivraison/{id}', [\App\Http\Controllers\LivraisonnnController::class,'updateStatus'])->name('updateStatusLivraison');
Route::get('/pdf', [\App\Http\Controllers\LivraisonnnController::class , 'pdf'])->name('pdf');
...
Route::delete('/delet/{adresseLivraison}', [AdresseLivraisonController::class , 'destroy'])->name('destroyL');
Route::get('/update/{adresseLivraison}', [AdresseLivraisonController::class , 'edit'])->name('updateLIV');
Route::put('/updateLIV/{adresseLivraison}', [AdresseLivraisonController::class , 'update'])->name('updateL');
