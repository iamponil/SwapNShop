...
<section class="bg0 p-t-104 p-b-116">
  <div class="container" style="
    ...
    <div class="size-209 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
      ...
      @endif
    <form action="{{route('community.updateCommunity', ['community'=>$community['id']])}}" method="POST">
    @csrf
    @method('PUT')
        ...
        <div class="bor8 m-b-20 how-pos4-parent">
          <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="name"
                 placeholder="Community Name" value="{{ $community['name'] }}">
          <i class="how-pos4 pointer-none fa-solid fa-people-arrows"></i>
        </div>
