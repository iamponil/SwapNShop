...
<div class="services section-background">
  <div class="container">
    ...
    left: 400px;
    top: 40px;" class="btn p-0" type="button" id="cardOpt3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i  class="bx bx-dots-vertical-rounded"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                  <a class="dropdown-item" href="{{route('community.edit',['community'=>$c])}}"><i class="fa-solid fa-pen-to-square"></i>Edit</a>
    ...
    <button type="submit" class="dropdown-item">
        ...
        <div class="service-item">
          ...
          <div class="down-content">
            ...
            <hr>
          {{$c->members->count()}} <i class="fa-solid fa-user"></i> @if($c->events->count() > 0) • <i class="fa-solid fa-calendar-days"></i> {{$c->events->sortByDesc('date_time')->first()->date_time}}   @endif
        </div>
        </div>
      </div>
      @endforeach
