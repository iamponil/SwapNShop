...
<header>
        ...
        <div class="menu-desktop">
          <ul class="main-menu">
            <li class="active-menu">
              <a href="{{ route('frontOfficeHome') }}">Home</a>
              <ul class="sub-menu">
                <li><a href="{{ route('frontOfficeHome') }}">Homepage 1</a></li>
  ...
  <div class="wrap-header-mobile">
    ...
    <div class="logo-mobile">
      <a href="{{ route('frontOfficeHome') }}"><img src="{{asset('assets/images/icons/logo-01.png')}}" alt="IMG-LOGO"></a>
    </div>
