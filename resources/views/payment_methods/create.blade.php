...
@section('content')
    ...
    <form method="POST" action="{{ route('payment_methods.store') }}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="type_methode_paiement" name="type_methode_paiement">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="titulaire_methode_paiement" name="titulaire_methode_paiement">
        </div>
        <div class="form-group">
